 ...
 */
final class Version20250423100120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE experience_pro_translation ADD id SERIAL NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE experience_pro_translation ADD PRIMARY KEY (id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE experience_pro_translation DROP id
        SQL);
        $this->addSql(<<<'SQL'
